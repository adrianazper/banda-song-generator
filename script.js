...
const cumbias = [
  {title: "Popurri: La Fea (DO) y La Peligrosa (Sib)",
    lyrics: `La Fea
    Nadie baila con la fea 
nadie la quiere invitar 
nadie baila con la fea 
nadie la quiere invitar

solita solita se pasa ocultada porque los muchachos no le dicen nada y es que ellos ignoran que sabe bailar 

solita solita se pasa ocultada porque los muchachos no le dicen nada y es que ellos ignoran que sabe bailar

plebilla calmada no le dicen nada ella lo que espera es que bien afinada la banda el recodo se ponga a tocar 
plebilla calmada no le dicen nada ella lo que espera es que bien afinada la banda el recodo se ponga a tocar

pero al tocar este ritmo solita solita se puso a bailar 
y todos muy asombrados la vieron bailando y quisieron bailar

y todos quieren con la fea todos quisieron bailar 
todos quieren con la fea todos quisieron bailar

musica`
  },

  {title: "Cahuates Pistaches (RE)",
    lyrics: `Yo vengo desde escuinapa a mazatlan a trabajar 
Yo vengo desde escuinapa a mazatlan a trabajar

y tengo una bicicleta con una jabita atras 
y tengo una bicicleta con una jabita atras

me dicen el pelirojo yo no se porque será 
me dicen el pelirojo yo no se porque será

yo vendo mis cahuatitos y pistaches nadamas 
yo vendo mis cahuatitos y pistaches nadamas

y la gente me dice y la gente le llama

y como le llaman compadre y como le llaman

cahuates cahuates cahuates cahuates

cahuates pistaches cahuates pistaches cahuates pistaches cahuates pistaches
...
Ay, ay, ay, ay que te alcanza el tiburón mamá ay, ay, ay, ay que te come el tiburón
...
Salte del agua mujer vente con migo a jugar que aguita y coco yo te voy a dar
...
const rancheras = [
  {title: "Mi Ranchito (FA)",
    lyrics: `Allá atrás de la montaña
Donde temprano se oculta el sol
Quedo mi ranchito triste y abandonada ya mi labor

Allí me pase los años, allí encontré mi primer amor
Y fueron los desengaños los que mataron a mi ilusión

Ay, corazón que te vas para nunca volver
No me digas adiós

No te despidas jamas si no quieres sentir
...
Malalla los ojos negros que me embrujaron con su mirar
Si nunca me hubieran visto
No fueran causa de mí penar`
  }, 

  {title: "Cuanto Me Gusta Este Rancho (FA)",
    lyrics: `Cuanto me gusta este rancho
por eso seguido vengo
mañana vuelvo a venir
a ver a un amor que tengo

eres chiquita y bonita
y asi como eres te quiero
paraces amapolita
cortada en el mes de enero

Musica

ya no vivo donde vivia
ahora vivo en una loma
quisiera ser gavilan
y que tu fueras paloma

ya no vivo donde vivia
ahora vivo en un estero
esa joven me la llevo
aunque me cueste dinero

Musica

eres chiquita y bo nita
y asi como eres te quiero
paraces amapolita
cortada en el mes de enero
...
a ver a un amor que tengo`}, 
  ...
  {title: "Por Ese Calle Vive (FA)",
    lyrics: ''}, 

  {title: "El Tarasco (Sib)",
    lyrics: ''},
    
  {title: "Carta Esther (FA)",
    lyrics: ''}, 

  {title: "Amor A La Ligera ()",
    lyrics: ''}, 
  ...
  {title: "Popurri: 30 Cartas (SOL) y Mi Gusto Es (FA)",
    lyrics: ''}, 
...
Por que la quize y la quiero
y no la podre olvidar
su marido anda diciendo
que a traicion me ha de matar
...
El amor y el dinero No se logran nunca sin riesgo Y jugare perdido Y yo quiero arañar el cielo

Y lo voy a lograr O en la batalla me muero Dios mío dame tu mano Si me quieres ver regresar

Esas montañas azul acero Me traen recuerdos de un gran lugar Que hasta los vientos me han reprochado Porque a mi tierra no eh vuelto mas

Y es que mis manos están vacías Y así no pienso volver jamás Yo tuve un sueño que no eh logrado Si no lo logro no vuelvo mas
...
Que lindo es Tepic, 
y todo Nayarit, 
Que lindo es mi Santiago, lugar donde naci, 
que me dice de Ixtlan, Acaponeta y Ruis, 
Tecuala la orgullosa, 
donde vivi feliz.

Musica

Cuando me voy a Tuxpan a pasiar, 
Ahi membriago de felicidad, luego me voy para Mescaltitan, 
al rodillero a sus playas a nadar,

Pero yo soy agraciado del cielo, 
de ser un hijo del mero Nayarit, 
tierra bendita que tanto adoro y quiero, 
es un orgullo haber nacido ahi.
...
Tecuala la orgullosa, donde vivi feliz.`}, 
  ...
  {title: "Caminos De Michoacan (FA)",
    lyrics: `Cariñito donde te hayas
...
Si por que me ves tomando paseandome en la pradera 
lo que si yo te aseguro que te quiero de a deveras.
...
Ya me voy a la barranca a sembrar zurcos de arroz 
yo te enseñare chamaca como se mancuernan dos.

Me puse a amar a una mujer 
con la ilusion de amar.`},
    
  {title: "Un Puño de Tierra (DO)",
    lyrics: `Cantando voy por la vida nomas recoriendo el mundo si quieren que se los diga 
...
y soy como las gaviotas volando de puerto en puerto yo se que la vida es corta 
al fin que tambien la debo

3-- el dia que yo me muera 
no voy a llevarme nada 
hay darle 
gusto al gusto 
la vida pronto se acaba 

lo que paso en este mundo nomas los recuerdos quedan ya muerto voy a llevarme nomas un puño de tierra
...
nomas un puño de tierra`}, 
  ...
  {title: "Por Las Calles De Chihuahua ()",
    lyrics: ''},

  {title: "La Novia Del Pajarillo ()",
    lyrics: ''}, 
...
nosotros sabemos querer a la buena cuando a una hembra amamos juramos amor 
Hay del que se meta tiene su condena 
le rajamos la alma por vida de dios

tierra ardiente cuna de valientes gallardos y altivos asi es nayarit nayarit 
cuando yo me encuentre por tierras lejanas antes de olvidarte prefiero morir.

Musica

cada nayarita es toda un patriota 
si la patria llama vamos a pelear 
la vida ofrendamos nada nos importa por ver que la patria siga en libertad

o raza de bronze que forma mi estado cada uno llevamos un sello de honor 
siendo nayarita esta garantizado morir por tu patria por su hembra y su honor

tierra ardiente cuna de valientes gallardos y altivos asi es nayarit nayarit 
cuando yo me encuentre por tierras lejanas antes de olvidarte prefiero morir.`},
  
  {title: "El Centenario ()",
    lyrics: `Si eres pobre te umilla la gente
si eres rico te tratan muy bien
un amigo se metio a la mafia 
porque pobre lla no quiso ser
ahora tiene dinero de sobra
por costales le pagan al mes

Todos le dicen el centenario
por la jolla que brilla en su pecho
ahora todos lo ven diferente
se acabaron todos sus desprecios
nomas porque tray carro del año 
ya lo ven con el signo de peso

3 -- Lo persigue el govierno gavacho
pero el no deja de trabajar
a Los Angeles va cada rato
y regresa con un dineral
el recive ordenes desde ariba 
...
en su corvert se pasea tranquilo
...
porque aqui no ay ningun parestesco
no se permite ningun error
siempre te andas rifando el pellejo 
con las leyes o con el parton.`}, 
...
robaba y mataba gente por que asi se divertia 
su cabeza tenia precio 
15 mil pesos valia

juan martha era aguerrido y temido del gobierno 
los rurales le temian 
como si fuera veneno

Musica

su madrecita lloraba ,lloraba y se lo decia 
si me dieran libre a mijo 
15 mil pesos daria

ya no llores madrecita ya no les ofrescas nada 
que llegando aquel cerrito 
yo me rio de la cordada
...
Y a otro que se la anda hechando 
...
Por Dios que borracho vengo que me echen con la "Tambora" que me toquen el "Quelite" despues el "Niño Perdido" y por ultimo el "Torito" pa' que vean como le brinco
...
Me dicen enamorado 
pero de eso nada tengo tambien me dicen el "Negro" el "Negro" pero con suerte por que si me salta un gallo no me le rajo a la muerte
...
Por Dios que borracho vengo que me sigan la "Tambora" que me toquen el "Quelite" despues el "Niño Perdido" y por ultimo el "Torito" pa' que vean como le brinco
...
muchachos allá va el toro, 
no se lo dejen llegar 
ay les mandaré el capote 
pa' que lo puedan torear...

Musica

La vaca era colorada y el becerrito era moro 
la vaca era colorada y el becerrito cera moro 
...
eso no sé 
ay si no sabes te enseñaré
eeeaaa eeeaaa eeeaaa eeeaaa eeeaaa

Toma, toma, 
toma torito toma 
torito de la barranca si quieres comer salitre 
torito brinca las trancas Apa toro que allá viene 
...
yo habito en un jacalito por fuera de la muralla...`}, 
  ...
  {title: "Pavido Navido ()",
    lyrics: `Ya se rebento el columpio,
...
a ver a mi niña tierna,
haber si bailar las puedo,
o me cargo hasta la greñas...
...
el cordon de churumbe...`}, 
  ...
  {title: "Popurri: La Boda Del Huitlacoche () y La Iguana ()",
    lyrics: ``},
]
...
const romanticas = [
  ...
  {title: "Un Rinconcito en el Cielo ()",
    lyrics: ''}, 
  
  {title: "En Los Puritos Huesos ()",
    lyrics: `Me perdonas mi amor por decirte la verdad a quema ropa Pero ya me canse de esperarme a que dejes a ese idiota Soy tu amante lo se te conosí casada pero eso no me impide sentir celos y rabia.

Es que quiero tener tus besos tu calor sin despedidas quiero tu libertad para ya no mirarnos a escondidas.

Quiero hacerte el amor como me venga en gana en la sala o en la ducha o en lo ancho de mi cama y gastarnos mil noches en caricias y besos no importa que me dejes en los puritos huesos.

Es que quiero obtener tus besos; tu calor sin despedidas quiero tu libertad para ya no mirarnos a escondidas.

Quiero hacerte el amor como me venga en gana en la sala o en la ducha o en lo ancho de mi cama y gastarnos mil noches en caricias y besos no importa que me dejes en los puritos huesos

Y gastarnos mil noches en caricias y besos no importa que me dejes en los puritos huesos.`}, 
...
document.getElementById("generateBtn").addEventListener("click", function () {
  ...
  document.getElementById("result").textContent = song.title;
